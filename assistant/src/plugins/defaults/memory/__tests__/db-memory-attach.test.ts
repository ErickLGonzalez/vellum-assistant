 ...
 *      `memory_v3_selections`, `activation_sessions`,
 *      `memory_v3_ever_injected`, `memory_retrospective_state`) live in the
 *      dedicated memory connection, not in the main connection — proving the
 *      physical split.
