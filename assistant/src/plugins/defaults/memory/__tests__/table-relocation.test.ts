...
const { ACTIVATION_STATE_RELOCATION } =
  await import("../../../../persistence/migrations/340-move-activation-state-to-memory-db.js");
const { CONVERSATION_GRAPH_MEMORY_STATE_RELOCATION } =
  await import("../../../../persistence/migrations/341-move-conversation-graph-memory-state-to-memory-db.js");
