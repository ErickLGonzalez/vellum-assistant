...
const { MEMORY_V3_EVER_INJECTED_RELOCATION } =
  await import("../../../../persistence/migrations/342-move-memory-v3-ever-injected-to-memory-db.js");
const { MEMORY_RETROSPECTIVE_STATE_RELOCATION } =
  await import("../../../../persistence/migrations/343-move-memory-retrospective-state-to-memory-db.js");
